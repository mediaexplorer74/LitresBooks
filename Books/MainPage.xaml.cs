...
namespace SDKTemplate
{
    ...
    public sealed partial class MainPage : Page
    {
        ...
        public MainPage()
        {
            ...
            // This is a static public property that allows downstream pages
            // to get a handle to the MainPage instance
        ...
        protected override void OnNavigatedTo(NavigationEventArgs e)
        {
            ...
            if (e.Parameter is string)
            {
                ...
                {
                    //NavigateToScenario(typeof(ReceiptView), param);
                }
            }
            */
        ...
        private void ScenarioControl_SelectionChanged(object sender, SelectionChangedEventArgs e)
        {
            ...
            if (s != null)
            {
                NavigateToScenario(s.ClassType);
            }
        }
        ...
        private void NavigateToScenario(Type scenario, object param = null)
        {
            ...
            StatusBlockScroller.MaxHeight = 140;//300;
        ...
        public void NotifyUser(string strMessage, NotifyType type, bool clearPrevious = false)
        {
            ...
            {
                var ignored = this.Dispatcher.RunAsync
                (
                    Windows.UI.Core.CoreDispatcherPriority.Normal, () => 
                    { NotifyUser(strMessage, type, clearPrevious); }
                );
